...
struct ContentView: View {
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 10) {
                ZStack {
                     Ellipse1().opacity(0.9)
                    Ellipse2().opacity(0.9)
                   Ellipse3().opacity(0.9)
                     Ellipse4().opacity(0.9)
                     Ellipse5().opacity(0.9)
                     HelloWorld().opacity(0.9)
...
Spacer()
                ...
                Button {
                    ...
                    .background(Color(red: 1, green: 1, blue: 1, opacity: 0.58).opacity(0.4))
                    .cornerRadius(70)
                    .overlay(RoundedRectangle(cornerRadius: 70).stroke(Color(red: 1, green: 0.99, blue: 0.99), lineWidth: 5))
...
struct Ellipse3: View {
    var body: some View {
        ZStack {
            ...
            Ellipse()
            .fill(LinearGradient(gradient: Gradient(colors: [Color(red: 0.46, green: 0.04, blue: 0.99, opacity: 0.53), Color(red: 0.79, green: 0.40, blue: 0.40, opacity: 0.49), Color(red: 1, green: 0.62, blue: 0.05, opacity: 0.47)]), startPoint: .top, endPoint: .bottom)).rotationEffect(.degrees(90))
            .offset(x: 60, y: 60)
            .frame(width: 130, height: 130)
